...
app.get('/predict', predictController.getPredict);
...
app.get('/api/district/list', districtController.getDistricts);
app.get('/api/wards', districtController.getWardByDistrict);
